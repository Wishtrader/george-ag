...
<section class="bg-white lg:bg-transparent relative h-auto lg:h-[300px]">
    ...
    <?php endif; ?>
  <div class="max-w-[1200px] w-full mx-auto px-[10px] flex flex-col lg:flex-row items-center justify-center lg:justify-between h-full relative text-center py-10 lg:py-0">
    <?php if ($cta_title): ?>
    <h2 class="text-[#2D2926] lg:!text-white mb-6 mx-auto max-w-[230px] md:max-w-full lg:text-left !leading-[1.5]">
